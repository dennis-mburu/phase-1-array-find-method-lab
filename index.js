...
//   function superbowlWin(list, finder){
...
//   function isWin(stats){
//       return stats.result === "W"
//   }

//   console.log(superbowlWin(record, isWin));

// function superbowlWin(array1){
//     let found = array1.find(function (){
//         for (elem of array1){
//             return (Object.values(array1)==="W")
//         }
//     })
//     return found
// }
    ...
    // item = arr.find((elem) => elem.result === "W")
    // console.log(item)
    // return item.year
}
